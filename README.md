...
If you would like to run Powerhouse locally, download the <ins>mainloader.html</ins> file if you always want the latest version which it grabs from the repository when you run it.
